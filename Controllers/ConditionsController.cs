...
namespace ProjektDotNet.Controllers
{
    ...
    public class ConditionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Condtition")] Condition condition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Condtition")] Condition condition)
        {
            if (id != condition.Id)
            {
                return NotFound();
